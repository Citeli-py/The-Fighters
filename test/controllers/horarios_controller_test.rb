...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference("Horario.count") do
      post horarios_url, params: { horario: { dia_semana: @horario.dia_semana, hora_fim: @horario.hora_fim, hora_inicio: @horario.hora_inicio, turma_id: @horario.turma_id } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { dia_semana: @horario.dia_semana, hora_fim: @horario.hora_fim, hora_inicio: @horario.hora_inicio, turma_id: @horario.turma_id } }
